...
},{"react":"jMk1U","react-dom":"i4X7T","./components/App":"7ZcYY","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","@parcel/transformer-react-refresh-wrap/lib/helpers/helpers.js":"7h6Pi","react/jsx-dev-runtime":"dVPUn"}],"jMk1U":[function(require,module,exports,__globalThis) {
'use strict';
...
},{"6f0162e9ab224cd4":"jMk1U"}],"7ZcYY":[function(require,module,exports,__globalThis) {
var $parcel$ReactRefreshHelpers$0b27 = require("@parcel/transformer-react-refresh-wrap/lib/helpers/helpers.js");
$parcel$ReactRefreshHelpers$0b27.init();
var prevRefreshReg = globalThis.$RefreshReg$;
var prevRefreshSig = globalThis.$RefreshSig$;
$parcel$ReactRefreshHelpers$0b27.prelude(module);
...
var _addDaysDefault = parcelHelpers.interopDefault(_addDays);
...
$RefreshReg$(_c, "App");
  ...
  $parcel$ReactRefreshHelpers$0b27.postlude(module);
} finally {
  globalThis.$RefreshReg$ = prevRefreshReg;
  globalThis.$RefreshSig$ = prevRefreshSig;
}
},{"react":"jMk1U","react-async-hook":"korXj","date-fns/addDays":"klfv9","date-fns/format":"hQsFo","./Orbital":"eD215","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","@parcel/transformer-react-refresh-wrap/lib/helpers/helpers.js":"7h6Pi","react/jsx-dev-runtime":"dVPUn"}],"korXj":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "useAsync", ()=>useAsync);
parcelHelpers.export(exports, "useAsyncAbortable", ()=>useAsyncAbortable);
parcelHelpers.export(exports, "useAsyncCallback", ()=>useAsyncCallback);
var _react = require("react");
function _extends() {
...
var useIsomorphicLayoutEffect = typeof window !== 'undefined' && typeof window.document !== 'undefined' && typeof window.document.createElement !== 'undefined' ? (0, _react.useLayoutEffect) : (0, _react.useEffect); // Assign current value to a ref and returns a stable getter to get the latest value.
...
var useAsyncState = function useAsyncState(options) {
    ...
    }), value1 = _useState[0], setValue = _useState[1];
    ...
    var setLoading = (0, _react.useCallback)(function() {
        return setValue(options.setLoading(value1));
    }, [
        value1,
        setValue
    ]);
    var setResult = (0, _react.useCallback)(function(result) {
        return setValue(options.setResult(result, value1));
    }, [
        value1,
        setValue
    ]);
    var setError = (0, _react.useCallback)(function(error) {
        return setValue(options.setError(error, value1));
    }, [
        value1,
        setValue
    ]);
    var merge = (0, _react.useCallback)(function(state) {
        return setValue(_extends({}, value1, {}, state));
    }, [
        value1,
        setValue
    ]);
...
var useAsyncInternal = function useAsyncInternal(asyncFunction, params, options) {
    ...
    var _useState2 = (0, _react.useState)(null), currentParams = _useState2[0], setCurrentParams = _useState2[1];
    ...
    var executeAsyncOperation = function executeAsyncOperation() {
        ...
        promise.then(function(result) {
            if (shouldHandlePromise(promise)) AsyncState.setResult(result);
            ...
            if (shouldHandlePromise(promise)) AsyncState.setError(error);
...
var useAsyncAbortable = function useAsyncAbortable(asyncFunction, params, options) {
    ...
    var asyncFunctionWrapper = function asyncFunctionWrapper() {
        for(var _len2 = arguments.length, p = new Array(_len2), _key2 = 0; _key2 < _len2; _key2++)p[_key2] = arguments[_key2];
        try {
            ...
            return Promise.resolve(_finallyRethrows(function() {
                ...
                return Promise.resolve(asyncFunction.apply(void 0, [
...
var useAsyncCallback = function useAsyncCallback(asyncFunction, options) {
    return useAsyncInternal(asyncFunction, // because async function is only executed manually
    [], _extends({}, options, {
...
},{}],"klfv9":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
/**
...
},{"./constructFrom.js":"la42H","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"hQsFo":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./differenceInCalendarDays.js":"1F4zu","./startOfYear.js":"kK73U","./toDate.js":"5dMgD","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"1F4zu":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
/**
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"eD215":[function(require,module,exports,__globalThis) {
var $parcel$ReactRefreshHelpers$6a58 = require("@parcel/transformer-react-refresh-wrap/lib/helpers/helpers.js");
$parcel$ReactRefreshHelpers$6a58.init();
var prevRefreshReg = globalThis.$RefreshReg$;
var prevRefreshSig = globalThis.$RefreshSig$;
$parcel$ReactRefreshHelpers$6a58.prelude(module);

try {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "default", ()=>Orbital);
var _jsxDevRuntime = require("react/jsx-dev-runtime");
var _react = require("react");
var _reactDefault = parcelHelpers.interopDefault(_react);
var _hazard = require("./Hazard");
var _hazardDefault = parcelHelpers.interopDefault(_hazard);
var _passing = require("./Passing");
var _passingDefault = parcelHelpers.interopDefault(_passing);
function Orbital({ name, is_potentially_hazardous_asteroid, close_approach_data, nasa_jpl_url }) {
    return /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)((0, _passingDefault.default), {
...
_c = Orbital;
var _c;
$RefreshReg$(_c, "Orbital");

  $parcel$ReactRefreshHelpers$6a58.postlude(module);
} finally {
  globalThis.$RefreshReg$ = prevRefreshReg;
  globalThis.$RefreshSig$ = prevRefreshSig;
}
},{"react":"jMk1U","./Hazard":"es5pM","./Passing":"bQUNZ","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","@parcel/transformer-react-refresh-wrap/lib/helpers/helpers.js":"7h6Pi","react/jsx-dev-runtime":"dVPUn"}],"es5pM":[function(require,module,exports,__globalThis) {
var $parcel$ReactRefreshHelpers$841b = require("@parcel/transformer-react-refresh-wrap/lib/helpers/helpers.js");
$parcel$ReactRefreshHelpers$841b.init();
var prevRefreshReg = globalThis.$RefreshReg$;
var prevRefreshSig = globalThis.$RefreshSig$;
...
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "default", ()=>Hazard);
var _jsxDevRuntime = require("react/jsx-dev-runtime");
var _react = require("react");
var _reactDefault = parcelHelpers.interopDefault(_react);
const YesNo = new Map([
...
function Hazard({ yes }) {
    return /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("span", {
        className: "hazard",
        children: YesNo.get(yes)
    }, void 0, false, {
        fileName: "src/components/Hazard.js",
        lineNumber: 8,
        columnNumber: 10
    }, this);
}
...
},{"react":"jMk1U","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","@parcel/transformer-react-refresh-wrap/lib/helpers/helpers.js":"7h6Pi","react/jsx-dev-runtime":"dVPUn"}],"7h6Pi":[function(require,module,exports,__globalThis) {
"use strict";
...
},{"58362d9d82be395f":"jMk1U"}],"bQUNZ":[function(require,module,exports,__globalThis) {
var $parcel$ReactRefreshHelpers$a50f = require("@parcel/transformer-react-refresh-wrap/lib/helpers/helpers.js");
$parcel$ReactRefreshHelpers$a50f.init();
var prevRefreshReg = globalThis.$RefreshReg$;
var prevRefreshSig = globalThis.$RefreshSig$;
$parcel$ReactRefreshHelpers$a50f.prelude(module);

try {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "default", ()=>Passing);
var _jsxDevRuntime = require("react/jsx-dev-runtime");
var _react = require("react");
var _reactDefault = parcelHelpers.interopDefault(_react);
var _formatNumber = require("format-number");
var _formatNumberDefault = parcelHelpers.interopDefault(_formatNumber);
var _format = require("date-fns/format");
var _formatDefault = parcelHelpers.interopDefault(_format);
const formatter = (0, _formatNumberDefault.default)();
function Passing({ data }) {
    return data.map((_, i)=>/*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("p", {
            children: [
                "Misses ",
                _.orbiting_body,
                " tomorrow at",
                ' ',
                (0, _formatDefault.default)(_.epoch_date_close_approach, 'h:mmaaaa'),
                " by",
                ' ',
                formatter(parseInt(_.miss_distance.miles, 10)),
                " miles whilst travelling at ",
                (0, _formatNumberDefault.default)({
                    truncate: 0
                })(_.relative_velocity.miles_per_hour),
                "mph"
            ]
        }, i, true, {
            fileName: "src/components/Passing.js",
            lineNumber: 9,
            columnNumber: 5
        }, this));
}
_c = Passing;
var _c;
$RefreshReg$(_c, "Passing");

  $parcel$ReactRefreshHelpers$a50f.postlude(module);
} finally {
  globalThis.$RefreshReg$ = prevRefreshReg;
  globalThis.$RefreshSig$ = prevRefreshSig;
}
},{"react":"jMk1U","format-number":"5KfPW","date-fns/format":"hQsFo","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","@parcel/transformer-react-refresh-wrap/lib/helpers/helpers.js":"7h6Pi","react/jsx-dev-runtime":"dVPUn"}],"5KfPW":[function(require,module,exports,__globalThis) {
...
function formatter(options) {
    ...
    // negative symbols '-' or '()'
    if (typeof options.negativeLeftSymbol !== 'string') switch(options.negativeType){
        case 'left':
    ...
    if (typeof options.negativeRightSymbol !== 'string') switch(options.negativeType){
        case 'right':
    ...
    if (typeof options.negativeLeftOut !== "boolean") options.negativeLeftOut = options.negativeOut === false ? false : true;
    if (typeof options.negativeRightOut !== "boolean") options.negativeRightOut = options.negativeOut === false ? false : true;
    //prefix and suffix
    options.prefix = options.prefix || '';
    options.suffix = options.suffix || '';
    //separators
    if (typeof options.integerSeparator !== 'string') options.integerSeparator = typeof options.separator === 'string' ? options.separator : ',';
    ...
    function format(number, overrideOptions) {
        ...
        if (number || number === 0) number = '' + number; //convert number to string if it isn't already
        else return '';
        ...
        if (!options.negativeLeftOut && !overrideOptions.noUnits) output.push(options.prefix);
        if (negative) output.push(options.negativeLeftSymbol);
        if (options.negativeLeftOut && !overrideOptions.noUnits) output.push(options.prefix);
        //Format core number
        number = number.split('.');
        ...
        if (options.negativeRightOut && !overrideOptions.noUnits) output.push(options.suffix);
        if (negative) output.push(options.negativeRightSymbol);
        if (!options.negativeRightOut && !overrideOptions.noUnits) output.push(options.suffix);
    ...
    function unformat(number, allowedSeparators) {
        ...
        if (options.allowedSeparators) options.allowedSeparators.forEach(function(s) {
        ...
        do {
            number = newNumber;
            for(var i = 0; i < allowedSeparators.length; i++)newNumber = newNumber.replace(allowedSeparators[i], '');
    ...
    function validate(number, allowedSeparators) {
        ...
        else if (options.truncate != null && number[1] && number[1].length > options.truncate) return false;
        else if (options.round != null && number[1] && number[1].length > options.round) return false;
        else return /^-?\d+\.?\d*$/.test(number);
    }
    return format;
}
...
function addIntegerSeparators(x, separator) {
    ...
    var rgx = /(\d+)(\d{3})/;
    while(rgx.test(x))x = x.replace(rgx, '$1' + separator + '$2');
    return x;
}
...
function padLeft(x, padding) {
    x = x + '';
    var buf = [];
    while(buf.length + x.length < padding)buf.push('0');
    return buf.join('') + x;
}
...
function truncate(x, length) {
    if (x) x += '';
    if (x && x.length > length) return x.substr(0, length);
    else return x;
}
...
},{}]},["5j6Kf","a0t4e"], "a0t4e", "parcelRequirebbb8", {}, null, null, "http://localhost:1234")
